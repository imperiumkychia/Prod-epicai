...
class PieCharRoundedCornerRenderer: BarChartRenderer {
    ...
    private var excludeBaseCorners: Bool = true
    
    init(dataProvider: BarChartDataProvider, animator: Animator, viewPortHandler: ViewPortHandler, cornerRadius: CGFloat, excludeBaseCorners: Bool) {
        
        super.init(dataProvider: dataProvider, animator: animator, viewPortHandler: viewPortHandler)
        
        self.cornerRadius = cornerRadius
        
        self.excludeBaseCorners = excludeBaseCorners
